    ...
    <div className="container pt-16 ">
        <div className="lg:flex justify-between items-center">
            ...
            <div className="space-x-4 mt-8 lg:mt-0">
                ...
                <button className="text-gray-600">Snacks</button>
            </div>
        </div>
        <div className="grid sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 pt-8 gap-2">
            <div>
                <img className="w-full h-full object-cover" src="https://thebravecoders-ecommerce-website-react-tailwind.vercel.app/feature__2.webp" alt="banner"/>
            </div>
