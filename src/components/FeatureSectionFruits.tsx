...
const data=[
    {id:0, img:"https://thebravecoders-ecommerce-website-react-tailwind.vercel.app/product__1.webp", name:"Dried kiwi",price:"$500"},
    {id:1, img:"https://thebravecoders-ecommerce-website-react-tailwind.vercel.app/product__2.webp", name:"Crunchy Crisps",price:"$300"},
    {id:2, img:"https://thebravecoders-ecommerce-website-react-tailwind.vercel.app/product__3.webp", name:"Jewel Cranberries",price:"$200"},
    ...
    <div className="container pt-16 ">
        <div className="lg:flex justify-between items-center">
            ...
            <div className="space-x-4 mt-8 lg:mt-0">
                ...
                <button className="text-gray-600">Bread & Bakery</button>
            </div>
        </div>
        <div className="grid sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 pt-8 gap-2">
            <div>
                <img className="w-full h-full object-cover" src="https://thebravecoders-ecommerce-website-react-tailwind.vercel.app/feature__1.webp" alt="banner"/>
            </div>
